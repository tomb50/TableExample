...
/*package*/ class UsesItem_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public UsesItem_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_tzwspi_a");
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.item$ORNy;
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.item$ORNy);
    }
